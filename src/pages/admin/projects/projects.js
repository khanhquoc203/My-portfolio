...
const ProjectsPage = () => {
    ...
    return /*html */`<div id="work" class="">
        <h1 class="text-center text-[25px] font-medium my-4">Projects Manage</h1>
        <table class="max-w-7xl items-center mx-auto table table-bordered table-auto border-collapse border-spacing-2 border border-slate-400">
            <thead>
                <tr>
                    ...
                    <th class="border border-slate-300">Projects</th>
            ...
            .map(
                ...
                <tr class="text-center">
                    ...
                    <td class="border border-slate-300">
                        ...
                        <a class="bg-blue-500 text-white px-3 py-1 rounded-lg hover:opacity-50" href="/admin/projects/${project.id}/edit">Edit</a>
                    </td>
                </tr>
            `
            )
